            ...
            <div class="row">
                <div class="col-md-5">
                    <h4 class="header-title">
                        {{ App\Models\EmdUserTransaction::TEST_MODE_TYPE[request()->route('type') ?? 0] }} Transaction</h4>
                </div>
                <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-body p-0">
                    <table id="transaction_table" class="table table-borderless emd-table1 transectionTable">
                        ...
                        <tbody>
                            @foreach (@$emd_transactions_test_register as $item)
                                <tr
                    ...
                    <div class="d-flex justify-content-end">
                        {{ $emd_transactions_test_register->links() }}
                    </div>
                </div>
            </div>
        </div>
